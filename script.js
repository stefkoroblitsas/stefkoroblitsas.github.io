...
var svgIcon = L.icon({
  iconUrl:
    "https://raw.githubusercontent.com/stefkoroblitsas/stefkoroblitsas.github.io/main/poi.svg",
  iconSize: [20, 20],
  iconAnchor: [0, 0],
  popupAnchor: [0, 0],
});
...
fetch(
  "https://raw.githubusercontent.com/stefkoroblitsas/stefkoroblitsas.github.io/main/movie_climbs.geojson"
)
  .then((response) => response.json())
  .then((data) => {
    allData = data;
    ...
    return fetch(
      "https://raw.githubusercontent.com/stefkoroblitsas/stefkoroblitsas.github.io/main/big_wall_climbs.geojson"
    );
  })
  .then((response) => response.json())
  .then((data) => {
